<template>
  <div class="flex gap-2 sm:gap-4 justify-between items-center w-full max-w-sm mx-auto">
    <input
      ...
      inputmode="numeric"
      maxlength="1"
      class="w-12 h-14 sm:w-14 sm:h-16 text-center text-2xl font-black text-gray-900 bg-gray-50 border border-transparent rounded-2xl focus:bg-white focus:border-[#065fdb] focus:ring-4 focus:ring-[#065fdb]/10 transition-all outline-none"
      :class="{ 'border-[#065fdb] bg-white': digits[index] }"
