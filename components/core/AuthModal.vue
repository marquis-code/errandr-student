            ...
            <DialogPanel class="w-full max-w-md transform overflow-hidden rounded-2xl bg-white text-left align-middle shadow-2xl transition-all">
              ...
              <div class="px-6 py-6 max-h-[70vh] overflow-y-auto">
                ...
                <div class="space-y-6">
                  ...
                  <button type="button" @click="handleFirebaseLogin" class="w-full py-3.5 border border-gray-100 rounded-2xl flex items-center justify-center gap-3 font-bold text-gray-700 hover:bg-gray-50 transition-all">
