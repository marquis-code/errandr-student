            ...
            <DialogPanel class="w-full max-w-md transform overflow-hidden rounded-[2rem] bg-white p-6 text-left align-middle shadow-xl transition-all border border-gray-100 relative">
              ...
              <div class="flex flex-col items-center text-center mt-4">
                ...
                <div class="w-full mt-6 space-y-3">
                  <button @click="goToCheckout" class="w-full py-4 bg-gray-900 hover:bg-black text-white rounded-2xl text-sm font-bold tracking-wide transition-colors">
...
const goToCheckout = () => {
  if (props.order?._id) {
    navigateTo(`/dashboard/orders/${props.order._id}`)
    closeModal()
  }
}
