<template>
  <div class="fixed bottom-4 left-4 z-[90] flex flex-col items-start">
    <!-- Modal -->
    <Transition
    ...
    <button
      @click="isOpen = !isOpen"
      class="w-12 h-12 rounded-full bg-[#128C7E] text-white flex items-center justify-center shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all focus:outline-none focus:ring-4 focus:ring-green-500/20"
      aria-label="WhatsApp Support"
    >
      <svg v-if="!isOpen" class="w-5 h-5 fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
