          ...
          >
            <DialogPanel class="w-full max-w-md transform overflow-hidden rounded-[3rem] bg-white p-8 md:p-12 text-center align-middle transition-all border border-gray-100">
              ...
              <DialogTitle as="h3" class="text-3xl font-black text-gray-900 tracking-tighter leading-none mb-4">
                Welcome home,<br/>
                <span class="text-parentPrimary italic">{{ firstName }}!</span>
              </DialogTitle>
              ...
              <div class="mt-12 space-y-4">
                <button
                  type="button"
                  class="w-full inline-flex justify-center items-center gap-2 rounded-2xl bg-gray-900 px-8 py-5 text-[10px] font-black uppercase tracking-[0.2em] text-white hover:bg-parentPrimary transition-all duration-300 active:scale-95 transition-all"
                  @click="closeModal"
                >
                  Let's get started <ArrowRight class="w-4 h-4" />
                </button>
                <p class="text-[10px] font-black text-gray-300 uppercase tracking-widest">Errandr — Campus Life, Elevated.</p>
              </div>
            </DialogPanel>
          </TransitionChild>
        </div>
