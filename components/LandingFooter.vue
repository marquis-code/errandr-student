  ...
  <footer class="relative bg-white overflow-hidden pt-24 border-t border-slate-100">
    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-10 relative z-10">
      ...
      <div class="mb-24 flex flex-col md:flex-row md:items-end justify-between gap-10">
        ...
        <NuxtLink to="/auth/register" class="inline-flex items-center gap-4 px-10 py-5 bg-parentPrimary text-white rounded-full font-black text-lg shadow-[0_20px_50px_rgba(255,92,26,0.3)] hover:scale-105 transition-transform group">
          Get Started
