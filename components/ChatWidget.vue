<template>
 ...
 v-if="isOpen"
 :class="[
 'bg-white rounded-[2rem] shadow-2xl border border-gray-100 overflow-hidden flex flex-col transition-all duration-300',
 'w-[360px] md:w-[400px] h-[500px] max-h-[85vh]',
 isMobile() ? 'fixed inset-0 !w-screen !h-screen !max-h-none rounded-none z-[999999]' : ''
 ]"
 >
 <div class="flex items-center justify-between px-5 py-4 bg-gray-900 text-white shadow-md relative z-10">
 <div>
