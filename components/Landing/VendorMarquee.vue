  ...
  <div class="relative py-20 overflow-hidden bg-gray-900 border-y border-white/5">
    ...
    <div class="flex flex-col gap-12">
      ...
      <div class="flex overflow-hidden group">
        <div class="flex animate-marquee whitespace-nowrap gap-12 items-center py-4">
          <div v-for="vendor in vendors" :key="vendor" class="flex items-center gap-6 group/item">
            <span class="text-6xl md:text-8xl font-black text-white/5 hover:text-parentPrimary transition-colors duration-700 tracking-tighter uppercase font-display cursor-default selection:bg-none">
              {{ vendor }}
            </span>
      ...
      <div class="text-center relative z-20">
        <p class="text-[10px] font-bold text-parentPrimary uppercase tracking-widest">Bringing Happiness to Students' Doorsteps</p>
      </div>
    </div>
  </div>
</template>
