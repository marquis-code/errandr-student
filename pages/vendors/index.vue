    ...
    <div class="flex flex-col lg:flex-row items-start">
      ...
      <aside class="hidden lg:block w-64 flex-shrink-0 fixed left-6 top-32 overflow-y-auto max-h-[calc(100vh-140px)] no-scrollbar bg-white/50 backdrop-blur-xl border border-gray-100 p-6 rounded-[2rem] shadow-[0_8px_30px_rgb(0,0,0,0.02)] z-10">
        <div class="space-y-8 pb-10">
          ...
          <div class="space-y-5">
            ...
            <div class="flex flex-col gap-2">
              <button
                ...
                class="flex items-center gap-3 px-4 py-3 rounded-2xl border transition-all text-sm font-bold w-full"
          ...
          <div>
            <h3 class="text-sm font-black text-gray-400  uppercase mb-4 px-2">Categories</h3>
      ...
      <main class="flex-1 min-w-0 pb-10 lg:ml-[300px]">
        ...
        <div class="flex items-end justify-between mb-8 border-b border-gray-100 pb-4">
          ...
          <div class="flex items-center gap-3">
            <button @click="showMobileFilters = true" class="lg:hidden flex items-center gap-2 px-4 py-2 border border-gray-200 rounded-xl text-sm font-bold text-gray-700 hover:bg-gray-50 transition-colors bg-white shadow-sm">
              <Filter class="w-4 h-4" /> Filters
            </button>
            <button @click="resetAllFilters" class="hidden sm:block text-sm font-black text-parentPrimary  hover:underline px-4 py-2 bg-parentPrimary/10 rounded-lg">Reset Filters</button>
          </div>
        </div>
          ...
          >
            ...
            <div class="relative aspect-video overflow-hidden bg-gray-50">
              ...
              <div class="absolute bottom-3 left-3">
                ...
                <div v-else :class="`w-10 h-10 rounded-xl border-2 border-white shadow-lg flex items-center justify-center text-white text-sm font-black tracking-tighter ${getVendorColor(vendor.storeName)}`">
              ...
              <div class="absolute top-3 right-3 flex flex-col gap-2 items-end">
                <div v-if="!vendor.isOpen" class="px-3 py-1 bg-gray-900/90 backdrop-blur-md rounded-full text-white text-sm font-black  shadow-lg">
                  CLOSED
                </div>
                <div v-else-if="vendor.offers?.length" class="px-3 py-1 bg-rose-500 rounded-full text-white text-sm font-black  shadow-lg animate-pulse whitespace-nowrap">
                  PROMO 🔥
                </div>
              </div>
            </div>
            ...
            <div class="p-5 space-y-3">
              ...
              <div class="flex flex-wrap items-center gap-3 text-sm font-semibold text-gray-500">
                ...
                <div class="flex items-center gap-1">
                  ...
                  <span class="text-sm uppercase r text-gray-400">Fee</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div v-if="!loading && filteredVendors.length === 0" class="w-full text-center py-24 px-6 bg-gray-50 rounded-3xl border border-dashed border-gray-200 mt-6">
          ...
          <button 
            ...
            class="px-8 py-3.5 bg-gray-900 text-white rounded-xl font-bold text-sm  hover:bg-parentPrimary transition-colors shadow-xl"
          >
            Reset All Filters
          </button>
        </div>
