<template>
  <div class="space-y-8 pb-24 animate-fade-in selection:bg-[#FF5C1A]/15 selection:text-[#FF5C1A] px-0 md:px-6">
    ...
    <section class="relative overflow-hidden rounded-2xl bg-[#171310] p-6 md:p-8 flex items-center justify-between group shadow-xl shadow-[#171310]/10">
      ...
      <div class="relative z-10 flex-1 max-w-xl">
        ...
        <NuxtLink to="/errands/custom" class="inline-flex items-center justify-center gap-2 px-6 py-3.5 bg-[#FF5C1A] text-white rounded-lg text-sm font-bold hover:bg-[#e6511a] transition-colors shadow-lg shadow-[#FF5C1A]/20 active:scale-95">
      ...
      <div class="hidden md:flex relative z-10 w-48 h-48 shrink-0 items-center justify-center">
        ...
        <div class="relative w-32 h-32 bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl rotate-12 flex items-center justify-center shadow-2xl group-hover:rotate-6 transition-transform duration-500">
    ...
    <section class="grid grid-cols-1 md:grid-cols-2 gap-4">
      <NuxtLink to="/meal-planner" class="bg-white border border-[#E7E2DA] rounded-xl p-6 flex items-center justify-between group hover:border-[#FF5C1A]/30 transition-all">
        <div>
      ...
      <NuxtLink to="/dashboard/group-orders" class="bg-white border border-[#E7E2DA] rounded-xl p-6 flex items-center justify-between group hover:border-[#FF5C1A]/30 transition-all">
        <div>
          <div class="w-10 h-10 bg-[#FAF8F5] border border-[#E7E2DA] rounded-lg flex items-center justify-center mb-3">
    ...
    <section class="space-y-4 pt-4">
      ...
      <div v-else-if="onlineVendors.length === 0" class="relative overflow-hidden rounded-2xl border border-[#E7E2DA] bg-white py-16 px-6 text-center group">
        ...
        <div class="relative z-10 flex flex-col items-center gap-4">
          ...
          <div class="flex items-center gap-3 w-full sm:w-auto justify-center mt-2">
            <button
              @click="fetchHomeData"
              class="flex-1 sm:flex-none inline-flex items-center justify-center gap-2 px-6 py-3 bg-[#171310] text-white rounded-lg text-[13px] font-bold hover:bg-black transition-colors shadow-lg shadow-[#171310]/10 active:scale-95"
            >
            ...
            <NuxtLink
              to="/vendors"
              class="flex-1 sm:flex-none inline-flex items-center justify-center px-6 py-3 bg-white border border-[#E7E2DA] text-[#171310] rounded-lg text-[13px] font-bold hover:bg-[#FAF8F5] transition-colors active:scale-95"
            >
              All Vendors
            </NuxtLink>
          </div>
