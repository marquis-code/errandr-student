  ...
  <div class="max-w-xl mx-auto space-y-6 pb-20 animate-fade-in selection:bg-parentPrimary/10 selection:text-parentPrimary pt-8 px-4">
    <div class="flex items-center gap-4">
      ...
      <div class="space-y-0.5">
        <h1 class="text-xl font-black text-gray-900 tracking-tight uppercase tracking-tighter">Payment Methods</h1>
        <p class="text-[9px] font-bold text-gray-400 uppercase tracking-widest">Manage your cards & billing</p>
      </div>
    </div>
    ...
    <div class="bg-white p-12 rounded-3xl border border-gray-100 shadow-sm text-center space-y-6 relative overflow-hidden group">
      ...
      <div class="relative z-10 space-y-2">
        ...
        <p class="text-[10px] font-bold text-gray-400 uppercase tracking-widest max-w-[200px] mx-auto leading-relaxed">Save your cards for faster checkout on your next order.</p>
      </div>
      <button class="relative z-10 w-full py-4 bg-gray-900 text-white rounded-xl text-[10px] font-black uppercase tracking-[0.2em] shadow-lg shadow-gray-900/10 hover:bg-parentPrimary transition-all active:scale-95">Add Payment Method</button>
    </div>
  </div>
</template>
