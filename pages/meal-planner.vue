      ...
      <div class="max-w-7xl mx-auto flex items-center justify-between bg-white/80 backdrop-blur-xl border border-white/50 p-4 rounded-[2rem] shadow-[0_10px_30px_rgba(0,0,0,0.03)]">
        <div class="flex items-center gap-4">
          ...
          <div>
            ...
            <p class="text-sm font-bold text-gray-400 uppercase tracking-[0.2em]">Budget & Nutrition Optimizer</p>
          </div>
        </div>
        <div class="flex items-center gap-2 px-4 py-2 bg-parentPrimary/5 rounded-2xl border border-parentPrimary/10">
          ...
          <span class="text-sm font-black text-parentPrimary uppercase ">All systems go</span>
        </div>
      </div>
    </header>
      ...
      <aside class="lg:col-span-4 space-y-6">
        <div class="bg-white p-8 rounded-[2.5rem] border border-gray-100 shadow-sm space-y-8 relative overflow-hidden group">
          ...
          <div class="relative z-10 space-y-8">
            <div class="space-y-4">
              <label class="text-sm font-black text-gray-400 tracking-[0.2em] uppercase ml-1 flex items-center gap-2 font-black">
            ...
            <div class="space-y-4">
              <label class="text-sm font-black text-gray-400 tracking-[0.2em] uppercase ml-1 flex items-center gap-2">
              ...
              <div class="flex gap-2 p-1.5 bg-gray-50 rounded-2xl border border-gray-100">
                <button 
                  ...
                  :key="i"
                  @click="mealsPerDay = i"
                  class="flex-1 py-3 rounded-xl text-sm font-black tracking-[0.1em] uppercase transition-all"
        ...
        <div v-if="plan" class="bg-gray-900 rounded-[2.5rem] p-8 text-white space-y-6 shadow-xl relative overflow-hidden group">
          ...
          <div class="relative z-10 space-y-4">
            <h4 class="text-sm font-black text-parentPrimary tracking-[0.2em] uppercase">Intelligence Report</h4>
            <p class="text-lg font-bold leading-snug tracking-tight">{{ plan.recommendation }}</p>
            <div class="pt-4 border-t border-white/10 flex justify-between items-end">
              <div>
                <p class="text-sm font-black text-gray-500 uppercase  leading-none mb-1">potential savings</p>
        ...
        <div v-if="plan" class="space-y-12 animate-fade-in">
          <div class="flex items-center justify-between px-2">
            <div>
              ...
              <p class="text-sm font-bold text-gray-400 uppercase ">Optimized for market & campus dining</p>
            </div>
            <div class="flex items-center gap-2">
               <button class="px-6 py-3 bg-white border border-gray-100 rounded-2xl text-sm font-black uppercase  shadow-sm hover:shadow-md transition-all">Download PDF</button>
            </div>
          </div>
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            >
              <div class="space-y-6">
                <div class="flex justify-between items-center pb-6 border-b border-gray-50">
                  <div class="px-4 py-1.5 bg-gray-900 text-white rounded-xl">
                    <span class="text-sm font-black uppercase ">Day {{ dayPlan.day }}</span>
                  </div>
                ...
                <div class="space-y-3">
                  ...
                  >
                    ...
                    <div class="flex-1 min-w-0">
                      <p class="text-sm font-black text-gray-400 uppercase  mb-0.5 group-hover/item:text-parentPrimary">{{ meal.type }}</p>
              ...
              <div class="mt-8 pt-6 border-t border-gray-50 flex items-center justify-between">
                <p class="text-sm font-black text-gray-400 uppercase ">Total value & nutrition</p>
            ...
            <div class="relative z-10 max-w-lg mx-auto space-y-6">
              ...
              <div class="flex justify-center flex-wrap gap-4 pt-4">
                <div class="px-6 py-3 bg-white/10 backdrop-blur-md rounded-2xl border border-white/20">
                  <p class="text-sm font-black uppercase  opacity-60">shopping days</p>
                  <p class="text-xl font-black">Weekends</p>
                </div>
                <div class="px-6 py-3 bg-white text-parentPrimary rounded-2xl shadow-xl">
                  <p class="text-sm font-black uppercase  opacity-60 text-parentPrimary/60">Estimated savings</p>
