  ...
  <div class="min-h-screen w-full flex flex-col md:flex-row bg-white overflow-hidden">
    ...
    <div class="hidden md:block w-1/2 relative overflow-hidden">
      ...
      <div class="relative z-10 flex flex-col justify-between h-full p-6 md:p-12 lg:p-16">
        ...
        <div class="max-w-md">
          <h2 class="text-5xl font-black text-white leading-[1.1] tracking-tighter mb-6">Verify it's you.</h2>
          <p class="text-white/70 text-lg font-medium leading-relaxed">Enter the 6-digit code sent to your email to continue your password reset.</p>
        </div>
      </div>
    </div>
    ...
    <div class="w-full md:w-1/2 flex flex-col justify-center px-6 sm:px-12 md:px-20 lg:px-28 py-12 relative z-10">
      <div class="mb-12">
        <NuxtLink to="/auth/forgot-password" class="inline-flex items-center gap-2 text-sm font-bold text-gray-500 hover:text-gray-900 transition-colors mb-8 group">
